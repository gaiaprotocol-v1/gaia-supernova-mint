...
export interface ISupernovaMinter extends BaseContract {
    ...
    functions: {
        ...
        userInitialMintingAmount(user: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        userInitialMintingAmount(user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initialMint(overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=ISupernovaMinter.d.ts.map